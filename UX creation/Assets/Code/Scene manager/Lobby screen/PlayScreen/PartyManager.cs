...
public class PartyManager : MonoBehaviour, IDataPersistence
{
    ...
    public GameObject PlayerSlot2Spawn;
    public bool PL2Taken;
    public GameObject PlayerSlot3Spawn;
    public bool PL3Taken;
    public GameObject PlayerSlot4Spawn;
    public bool PL4Taken;
